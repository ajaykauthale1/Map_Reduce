...
public class CoarseLockFib {
	 ...
	 * 
	 */
	public static void coarseLockFibTMAX() {
		// load file and convert it into simple lines
		List<String> lines = LoaderRoutine.loadFile("1912.csv.gz");

		PrintStream out = null;
		try {
			out = new PrintStream(new FileOutputStream(LoaderRoutine.ROOT_DIR + "\\output\\coarselockfib.txt"));
	...
	public static void main(String[] args) {
		CoarseLockFib.coarseLockFibTMAX();
	}
